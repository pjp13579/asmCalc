...
printOutput proc                                                          			
	...
	; do not use the arrayIsZero later on, cus arrayIsZero inernally uses di  and later on di will be pointing to the video memory offset
	lea di, result	
	call arrayIsZero	
	mov cx, dx
