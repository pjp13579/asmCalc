...
.DATA                                  
	...
	calculatorUI db "",
		db "��������������������͹Smart Logic Based calculator�������������������ͻ",13,10,
		db "�                                                                     �",13,10,
		db "�                                                                     �",13,10,
		db "�                                                                     �",13,10,
		db "���������������������������������������������������������������������͹",13,10,
...
nifValidator proc
    ...
    CheckDigitDone:
        ...
        lea si, numberTwo
        add si, 14                ; Point to the 9th digit (last digit of NIF)
...
EANVALLoop:
    ...
    lea si, numberTwo
    add si, 12                ; Point to the 9th digit (last digit of EAN)
    mov bl, [si]             ; Load last digit from arr1
...
renderUI proc
	...
	writeSymbolToVideoMemory:
		...
		; "��������������������͹Smart Logic Based calculator�������������������ͻ",13,10,
		; "�                                                                     �",13,10,
		; "�                                                                     �",13,10,
		; "�                                                                     �",13,10,
		; "���������������������������������������������������������������������͹",13,10,
		...
		; "���������������������������������������������������������������������͹",13,10,
		; "�             �             �             �             �             �",13,10,
		; "� 80 * 10 + 7 � 80 * 10 + 21� 80 * 10 + 35�    EAN13    �     NIF     �",13,10,
		; "�             �             �             �             �             �",13,10,
		; "���������������������������������������������������������������������͹",13,10,
		; "�             �             �             �             �             �",13,10,
		; "� 80 * 14 + 7 � 80 * 14 + 21� 80 * 14 + 35�     ��      �     C C     �",13,10,
		; "�             �             �             �             �             �",13,10,
		; "���������������������������������������������������������������������͹",13,10,
		; "�             �             �             �             �             �",13,10,
		; "� 80 * 18 + 7 � 80 * 18 + 21� 80 * 18 + 35�      +      �      -      �",13,10,
		; "�             �             �             �             �             �",13,10,
		; "���������������������������������������������������������������������͹",13,10,
		; "�             �             �             �             �             �",13,10,
		; "� 80 * 22 + 7 �      .      �     END     �      *      �      /      �",13,10,
